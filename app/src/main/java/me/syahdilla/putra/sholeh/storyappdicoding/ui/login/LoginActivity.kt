...
import me.syahdilla.putra.sholeh.storyappdicoding.ui.signup.EMAIL_REGISTER_RESULT
import me.syahdilla.putra.sholeh.storyappdicoding.ui.signup.PASSWORD_REGISTER_RESULT
import me.syahdilla.putra.sholeh.storyappdicoding.ui.signup.SignupActivity
...
class LoginActivity : BaseActivity<ActivityLoginBinding>(ActivityLoginBinding::inflate) {
    ...
    override suspend fun onInitialize(savedInstanceState: Bundle?) = with(binding) {
        ...
        btnSignup.setOnClickListener {
            launcher.open(SignupActivity::class,
                useActivityTransition = false,
                banner to "banner",
