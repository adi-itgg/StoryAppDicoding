package me.syahdilla.putra.sholeh.storyappdicoding.core.data.source.remote.network
...
interface DicodingApiService {
    ...
    @POST("login")
    fun login(
        @Body userLogin: me.syahdilla.putra.sholeh.storyappdicoding.core.data.UserLogin
    ): Call<UserResponse>
